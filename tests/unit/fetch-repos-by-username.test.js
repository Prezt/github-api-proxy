import { fetchReposByUsername } from "../../src/users/users-controller"
...
describe('Test the fetch repos by username function', () => {
    ...
    it('1) Should send data with status 200 if the request is successful', async () => {
        ...
        await fetchReposByUsername(mockReq, mockRes);
    ...
    it('3) Should send error message with status 500 if the request is successful', async () => {
        const mockedAxiosResponse = { message: 'Unexpected fetch repos by username Error' }
